  ...
  return (
    <div className="rounded-lg border border-border-strong bg-surface-raised">
      ...
      <div className="px-5 py-4">
        <div className="prose-sm max-w-none text-[14px] leading-relaxed [&_a]:text-accent-text [&_code]:rounded [&_code]:bg-accent-soft [&_code]:px-1 [&_pre]:overflow-x-auto [&_pre]:rounded [&_pre]:bg-accent-soft [&_pre]:p-2">
